...
export default function BigDesktopDetail() {
        ...
        return (
          <div className="flex flex-row gap-8">
            <button
              ...
              className="px-5 py-2 text-xl border-2 border-white rounded-md cursor-pointer">
              Trailer
            </button>
            <button
              onClick={() => {
              ...
              className="cursor-pointer  text-xl text-white border-2 border-[#ae1f22] bg-[#ae1f22] rounded-md px-6 py-3">
              Get Tickets
            </button>
          </div>
        );
        ...
        return (
          <div className="">
            <button
              ...
              className="px-6 py-3 text-xl border-2 border-white rounded-md cursor-pointer">
              Trailer
            </button>
          </div>
        );
        ...
        overlayElement={(props, contentElement) => (
          <div {...props}>
            <div className="absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 w-fit ">
              {contentElement}
              <figure className="absolute w-12 h-12 -top-10 -right-10">
                <img
