...
export default function TabletPortraitDetail() {
        ...
        return (
          <div className="flex flex-row justify-center gap-10">
            <button
              ...
              className="px-8 py-4 text-3xl border-2 border-white rounded-md cursor-pointer">
              Trailer
            </button>
        ...
        return (
          <div className="flex flex-row justify-center">
            <button
              ...
              className="px-6 py-3 text-4xl border-2 border-white rounded-md cursor-pointer">
              Trailer
            </button>
          </div>
        );
    ...
    return (
      <div className="w-[90%] mr-auto ml-auto py-6">
        <div className="flex flex-col items-center justify-center">
          <figure className="overflow-hidden rounded-md h-[40rem] aspect-auto mb-8">
            <img
          ...
          <div>
            ...
            <p className="mb-6 text-2xl flex-[20px]">
            ...
            <ul className="mb-12 space-y-4">
              <li>
                <span className="mr-6 text-2xl font-bold">Date Release:</span>
                <span className="text-xl">Bob Smith</span>
              </li>
              <li>
                <span className="mr-6 text-2xl font-bold">Director:</span>
                <span className="text-xl">Bob Smith</span>
              </li>
              <li>
                <span className="mr-6 text-2xl font-bold">Cast:</span>
                <span className="text-xl">Bob Smith</span>
              </li>
              <li>
                <span className="mr-6 text-2xl font-bold">Genres:</span>
