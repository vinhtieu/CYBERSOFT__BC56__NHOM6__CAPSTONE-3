...
export default function TabletLandscapeDetail() {
        ...
        return (
          <div className="">
            <button
              ...
              className="px-6 py-3 text-2xl border-2 border-white rounded-md cursor-pointer">
              Trailer
            </button>
            <button className="cursor-pointer  text-2xl text-white border-2 border-[#ae1f22] bg-[#ae1f22] rounded-md px-6 py-3">
              Get Tickets
            </button>
          </div>
        );
  ...
  const renderMovieDetail = () => {
    ...
    return (
      <div className="w-[90%] mr-auto ml-auto py-10">
        <div className="flex flex-row ">
          <figure className="h-[30.5rem] aspect-[11/17] mr-12 rounded-md ">
            <img
