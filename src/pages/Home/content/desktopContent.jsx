...
const DesktopContent = () => {
  ...
  return (
    <div>
      <div className="block w-[90%] ml-auto px-2 mr-auto mb-5 mt-20 text-white text-3xl leading-[1.5vw] font-bold z-50 relative">
        Now Playing
      </div>
      ...
      <div className="block w-[90%] ml-auto px-2 mr-auto mb-5  text-white text-3xl leading-[1.5vw] font-bold z-50 relative">
        Coming Soon
      </div>
      <Carousel className="mb-28">
