...
const BigDesktopContent = () => {
  ...
  return (
    <div>
      <div className="block w-[90%] ml-auto px-2 mr-auto mb-5 mt-24 text-white text-[1.6vw] leading-[1.5vw] font-bold z-50 relative">
        Now Playing
      </div>
      ...
      <div className="block w-[90%] ml-auto px-2 mr-auto mb-5  text-white text-[1.6vw]  leading-[1.5vw] font-bold z-50 relative">
        Coming Soon
      </div>
      <Carousel className="mb-32 ">
